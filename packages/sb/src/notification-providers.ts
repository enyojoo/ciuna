...
export class NotificationProviderFactory {
  private static smsProvider: TwilioSMSProvider;
  private static emailProvider: SendGridEmailProvider;
  private static fcmProvider: FCMProvider;
