...
import type { ServiceWithRelations, ServiceBookingWithRelations } from '@ciuna/types';
...
export default function ServiceDetailPage() {
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      const { data: booking } = await db.bookings.create(bookingData);
        ...
        <div className="lg:col-span-2">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center text-gray-600 mb-4">
              ...
              {service.is_online && service.is_in_person && ' • Online Available'}
            </div>
            ...
            <CardContent className="p-6">
              ...
              <div className="flex items-start space-x-4">
                <Avatar
                  ...
                  fallback={service.provider.name.charAt(0)}
                  size="lg"
                />
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-600 ml-1">({service.provider.review_count} reviews)</span>
                    </div>
                    <div className="text-gray-600">
                      {service.provider.completed_bookings} completed bookings
                    </div>
                  </div>
                </div>
              </div>
