          ...
          <div className="mb-8">
            <div className="relative">
              ...
              {canScrollLeft && (
                <Button
                  variant="outline"
                  className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-sm hover:bg-gray-50 border-gray-200 w-10 h-10"
                  onClick={scrollLeft}
                >
              ...
              {canScrollRight && (
                <Button
                  variant="outline"
                  className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-sm hover:bg-gray-50 border-gray-200 w-10 h-10"
                  onClick={scrollRight}
                >
