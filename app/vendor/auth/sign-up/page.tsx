...
export default function VendorSignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.agreeToTerms || !formData.agreeToVendorTerms) {
      ...
      <div className="w-full max-w-md">
        <Card>
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl">Vendor Account Setup</CardTitle>
            <CardDescription>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setFormData(prev => ({ ...prev, agreeToVendorTerms: !!checked }))}
                  />
                  <Label htmlFor="vendorTerms" className="text-sm">
                    I agree to the{' '}
                    <a href="/vendor-terms" className="text-green-600 hover:underline">
