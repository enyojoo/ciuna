...
import { hubProductEditPath } from "@/lib/hub-office-paths"
...
export function OfficeHubNewProductForm({ backHref }: { backHref: string }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(hubProductEditPath(data.product.id))
    } catch (err: unknown) {
